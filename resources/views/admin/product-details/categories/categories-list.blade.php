...
@section('content')
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            ...
            <div>
                <a href="{{route('admin_categories_add')}}" class="btn btn-outline-gray"><i class="far fa-plus-square mr-1"></i> Add New Category</a>
            </div>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="border-0">
                                @if($value->images !== null)
                                    <img class="img-list" src="{{asset('uploads/categories/'.$value->images)}}" alt="{{$value->title}}">
                                @else
                                    <span>-</span>
                                @endif
                            </td>
                            ...
                            <td class="border-0">
                                <a href="{{route('admin_categories_edit').'/'.$value->id}}" class="text-secondary mr-3"><i class="fas fa-edit"></i>Edit</a>
                                <span class="text-primary"> |  </span>
                                <a href="{{route('admin_categories_delete').'/'.$value->id}}" class="text-danger ml-3"><i class="far fa-trash-alt"></i>Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    <!-- End of Item -->
