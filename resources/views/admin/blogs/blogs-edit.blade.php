    ...
    <div class="py-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{route('admin_blogs')}}">Blog-List</a></li>
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-12 col-sm-12">
                                ...
                                @endif
                                <form action="{{route('admin_blogs_add_edit').'/'.$blog->id}}" method="POST" enctype="multipart/form-data">@csrf
                                    <div class="mb-4">
                                    ...
                                    <div class="my-4">
                                        ...
                                        <textarea class="form-control" placeholder="Enter your message..." id="textarea" rows="4" name="description">{{$blog->description}}</textarea>
                                    </div>
                                    <div class="form-file mb-3">
                                        ...
                                        <img class="img-fluid image-preview" alt="" id="" src="{{url('uploads/blogs/').'/'.$blog->images}}">
                                    </div>
                                    <fieldset class="my-4">
